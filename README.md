...
Official project documentation found [here](https://github.com/on2itsecurity/etcd-operator)
...
| `rbac.apiVersion`                                 | RBAC api version `v1`                                                | `v1`                                           |
...
| `etcdOperator.image.repository`                   | etcd-operator container image                                        | `ghcr.io/on2itsecurity/etcd-operator`          |
| `etcdOperator.image.tag`                          | etcd-operator container image tag                                    | `v1.2.0`                                       |
...
| `etcdCluster.version`                             | etcd cluster version                                                 | `3.4.18`                                       |
